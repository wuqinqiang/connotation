...
class MockingParameterAndReturnTypesTest extends MockeryTestCase
{
    ...
    {
        $mock = mock("tests\Mockery\TestWithParameterAndReturnType");
    ...
    {
        $spy = \Mockery::spy("tests\Mockery\TestWithParameterAndReturnType");

        $this->assertInstanceOf("tests\Mockery\TestWithParameterAndReturnType", $spy->returnSelf());
    }
