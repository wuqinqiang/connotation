...
class TestListenerTest extends MockeryTestCase
{
    protected function mockeryTestSetUp()
    {
        ...
        // We intentionally tests the static container here. That is what the
        // listener will check.
        ...
        $this->assertTrue($this->testResult->wasSuccessful(), 'sanity check: empty tests results should be considered successful');
    }
    ...
    public function testSuccessOnClose()
    {
        ...
        $this->assertTrue($this->testResult->wasSuccessful(), 'expected tests result to indicate success');
    }
    ...
    public function testFailureOnMissingClose()
    {
        ...
        $this->listener->endTest($this->test, 0);
        $this->assertFalse($this->testResult->wasSuccessful(), 'expected tests result to indicate failure');
