...
abstract class TestCase extends Assert implements SelfDescribing, Test
{
    ...
    public function getMockBuilder($className): MockBuilder
    {
        if (!\is_string($className)) {
            $this->addWarning('Passing an array of interface names to getMockBuilder() for creating a tests double that implements multiple interfaces is deprecated and will no longer be supported in PHPUnit 9.');
        }
    ...
    protected function createMock($originalClassName): MockObject
    {
        if (!\is_string($originalClassName)) {
            $this->addWarning('Passing an array of interface names to createMock() for creating a tests double that implements multiple interfaces is deprecated and will no longer be supported in PHPUnit 9.');
        }
    ...
    {
        if (!\is_string($originalClassName)) {
            $this->addWarning('Passing an array of interface names to createPartialMock() for creating a tests double that implements multiple interfaces is deprecated and will no longer be supported in PHPUnit 9.');
        }
